...
const EID_HIKAMI_BENCHMARK: usize = 0x0A000088;
const FID_HIKAMI_SET_DELEG_ILL_INSN: usize = 0x0;
...
/// Puts a character to the console.
pub fn deleg_illegal_insn(enable: bool) -> (usize, usize) {
    if cfg!(feature = "megrez") {
        sbi_call(
            EID_HIKAMI_BENCHMARK,
            FID_HIKAMI_SET_DELEG_ILL_INSN,
            enable as usize,
            0,
            0,
        )
